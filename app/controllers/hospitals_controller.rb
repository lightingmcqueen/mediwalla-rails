class HospitalsController < ApplicationController
  ...
  private
    ...
    def clinic_params
      params.require(:clinic).permit(:clinic_admin_id, :name, :description, :services, :address_line_1, :address_line_2, :city, :country_id, :zipcode_string, :coordinator, :ratings)
    end
end
