class ProceduresController < ApplicationController
  ...
  private
    ...
    def procedure_params
      params.require(:procedure).permit(:clinic_id, :procedure_category_id, :procedure_subcategory_id, :name, :overview, :procedure_before, :procedure_after, :price, :hospital_time, :abroad_time)
    end
end
